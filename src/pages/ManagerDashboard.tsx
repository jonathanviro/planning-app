...
export default function ManagerDashboard() {
  ...
  // Optimizamos la sección de gráficos para que no se renderice cuando cambia topCount
            ...
            <ResponsiveContainer width="100%" height="100%">
              <PieChart>
                <Pie
                  ...
                  label
                >
                  {hoursByPriority.map((entry, index) => (
                    <Cell
                      key={`cell-${index}`}
                      fill={entry.name === "Must Have" ? COLORS[0] : COLORS[3]}
                    />
                  ))}
                </Pie>
                <Tooltip />
          ...
          <div className="flex-1 min-h-0">
            <ResponsiveContainer width="100%" height="100%">
              ...
              >
                ...
                <Bar dataKey="SP Company Project" stackId="a" fill={COLORS[1]}>
                  <LabelList
